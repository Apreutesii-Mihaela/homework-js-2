...
function defUpperStr(text) {
  var result = text || "DEFAULT TEXT";
  return result.toLocaleUpperCase();
}
console.log(defUpperStr());

// console.log(defUpperStr('My text').toLocaleUpperCase())
 ...
 * #7
 *
 * Создайте функцию (oddFnn), которая принимает параметром число – количество итераций цикла.
